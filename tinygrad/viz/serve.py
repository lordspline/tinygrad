...
uops_colors = {Ops.LOAD: "#ffc0c0", Ops.STORE: "#87CEEB", Ops.CONST: "#e0e0e0", Ops.VCONST: "#e0e0e0", Ops.REDUCE: "#FF5B5B",
               ...
               Ops.RANGE: "#c8a0e0", Ops.STORE: "#909090", Ops.BARRIER: "#ff8080", Ops.IF: "#c8b0c0", Ops.SPECIAL: "#c0c0ff",
...
def uop_to_json(x:UOp) -> dict[int, dict]:
  ...
  for u in toposort:
    ...
    try:
      if u.op not in {Ops.VIEW, Ops.BUFFER, Ops.KERNEL, Ops.STORE, Ops.COPY, Ops.SINK, *GroupOp.Buffer} and u.st is not None:
